...
```
Additionally, I have added some variable substitutions to make life a little easier for remembering input parameters. They are easily changeable and are as follows by default:
```
'mu' = dynamic viscosity
'rho' = density
'cp' = specific heat capacity for constant pressure
